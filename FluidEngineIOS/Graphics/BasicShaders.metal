...
fragment half4 select_custom_box2d_fragment_shader(ColorRasterizerData rd [[ stage_in ]],
    ...
    color.r = clamp(color.r + selectColor.r * 0.4 * sin(texCoord.x * 10 + totalGameTime * 5 * color.r), selectColor.r, 1.0);
    color.g = clamp(color.g + selectColor.g * 0.4 * sin(texCoord.x * 10 + totalGameTime * 5 * color.g), selectColor.g, 1.0);
    color.b = clamp(color.b + selectColor.b * 0.4 * sin(texCoord.x * 10 + totalGameTime * 5 * color.b), selectColor.b, 1.0);
